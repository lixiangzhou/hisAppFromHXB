...
- (void)setup {
    ...
    [self registerClass:[HXBFinancePlanListCell class] forCellReuseIdentifier:CELLID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    HXBFinancePlanListCell *cell = [tableView dequeueReusableCellWithIdentifier:CELLID forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    //拿到cell的model
    HXBFinancePlanListCell *cell = [tableView cellForRowAtIndexPath:indexPath];
