...
#import "HXBFinancePlanListCell.h"//红利计划的cell
...
- (void)setUPLoanTransferTableView {
    kWeakSelf
    self.loanTruansferTableView = [[HXBFinancting_LoanTransferTableView alloc]initWithFrame:CGRectZero style:UITableViewStylePlain];
    //上拉刷新，下拉加载（判断条数是否）
