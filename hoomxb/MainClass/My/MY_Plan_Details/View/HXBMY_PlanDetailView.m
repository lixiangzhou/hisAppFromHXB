...
- (void)setUPValueWithViewManagerBlock: (HXBMY_PlanDetailView_Manager *(^)(HXBMY_PlanDetailView_Manager *manager))viewManagerBlock{
    ...
    if ([weakSelf.manager.planDetailModel.novice isEqualToString:@"1"]) {
        if (weakSelf.manager.type == HXBRequestType_MY_PlanRequestType_HOLD_PLAN || weakSelf.manager.type == HXBRequestType_MY_PlanRequestType_EXITING_PLAN)
        {
