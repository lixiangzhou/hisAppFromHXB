...
#import "HXBBaseWaveView.h"


@interface HXBBaseWaveView()
...
@implementation HXBBaseWaveView
...
- (void)getPath {
    ...
    switch (self.pathType) {
        case HXBBaseWaveViewPathType_CIRCULAR://圆形
            _path = [UIBezierPath bezierPathWithOvalInRect:self.bounds];
            break;
        case HXBBaseWaveViewPathType_RECT://矩形
