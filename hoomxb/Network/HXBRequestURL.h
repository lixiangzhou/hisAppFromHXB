...
#define kHXBMY_PlanQuitURL(planID) [NSString stringWithFormat:@"/account/plan/%@/quit",(planID)]
#define kHXBMY_PlanAssetsURL @"/account/plan"// plan 资金统计
#define kHXBMY_PlanBeforeQuitURL(planBID) [NSString stringWithFormat:@"account/plan/%@/quit",(planID)]// plan 计划预退出
#define kHXBMY_PlanQuitResultURL(planID) [NSString stringWithFormat:@"/account/plan/%@/quit",(planID)] /// plan 获取计划退出结果
#define kHXBMY_PlanCancelBuyURL(planID) [NSString stringWithFormat:@"/account/plan/%@/cancelbuy",(planID)]// plan 冷静期计划取消加入前确认
#define kHXBMY_PlanCancelBuyResultURL(planID) [NSString stringWithFormat:@"/account/plan/%@/cancelbuy",(planID)] /// plan 冷静期计划取消加入结果
