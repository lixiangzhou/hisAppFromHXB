...
// 点击图片的方法
- (void)tapImageView {
    HXBXYAlertViewController *alertVC = [[HXBXYAlertViewController alloc] initWithTitle:@"温馨提示" Massage:@"待转出金额为0时，红利计划完成退出，退出期间，正常计息。" force:2 andLeftButtonMassage:@"" andRightButtonMassage:@"确定"];
