...
- (void)buildUI {
    ...
    UIView *shadowView = [[UIView alloc] initWithFrame:CGRectMake(0, kScrAdaptationH750(69), kScreenWidth, kScrAdaptationH750(1))];
    shadowView.backgroundColor = COR32;
    shadowView.layer.shadowColor = [UIColor blackColor].CGColor;//shadowColor阴影颜色
    shadowView.layer.shadowOffset = CGSizeMake(2, 3);//shadowOffset阴影偏移,x向右偏移4，y向下偏移4，默认(0, -3),这个跟shadowRadius配合使用
