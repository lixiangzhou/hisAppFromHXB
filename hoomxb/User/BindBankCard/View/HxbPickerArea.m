...
@interface HxbPickerArea()<UIPickerViewDataSource, UIPickerViewDelegate>
...
/** 7.工具器 */
@property (nonatomic, strong, nullable)HxbToolbar *toolbar;
/** 8.边线 */
...
- (UIPickerView *)pickerView
{
    if (!_pickerView) {
        ...
        CGFloat pickerH = PickerViewHeight - HxbControlSystemHeight;
        CGFloat pickerX = 0;
        CGFloat pickerY = SCREEN_HEIGHT+HxbControlSystemHeight;
...
{
    if (!_toolbar) {
        _toolbar = [[HxbToolbar alloc]initWithTitle:@"选择城市地区"
