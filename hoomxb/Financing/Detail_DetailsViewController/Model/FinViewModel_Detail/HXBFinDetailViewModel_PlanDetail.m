...
- (void)setUPLockPeriod {
    NSString *lockStr = [self.planDetailModel.novice isEqualToString:@"1"]&&self.planDetailModel.lockDays ? [NSString stringWithFormat: @"%@天",self.planDetailModel.lockDays] : [NSString stringWithFormat: @"%@个月",self.planDetailModel.extendLockPeriod];
