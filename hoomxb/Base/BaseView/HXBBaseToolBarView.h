...
@interface HXBBaseToolBarView : UIView
...
/**item点击事件回调*/
- (void)clickOptionItemBLockFuncWithClickOptionItemBlock: (void(^)(UIButton *button,NSString *itemText, NSInteger index)) clickOptionItemBlock;
